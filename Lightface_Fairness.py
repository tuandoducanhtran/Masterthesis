...
with open (r"C:\Users\tuanm\Desktop\MasterThesis\Dataset\Evaluation\Labels\fairface_label_eval.csv") as label_train_csv:
        csv_reader = reader(label_train_csv)
        fairface_label_all = list(csv_reader)
        
# open output from csv as list output_deepface
with open (r"C:\Users\tuanm\Desktop\MasterThesis\Output\Deepface\on_fairface\output_deepface_on_Fairface_full_final.csv") as output_deepface_csv:
...
# f = open (r"C:\Users\tuanm\Desktop\MasterThesis\Output\Deepface\fairness_deepface_on_utk_final.csv", "w", newline ="")
# writer = csv.writer(f)
