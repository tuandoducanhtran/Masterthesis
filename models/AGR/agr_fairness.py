...
# CHANGE
with open (r"C:\Users\tuanm\Desktop\MasterThesis\Output\AGR_ft\on_fairface\output_agrnewft3_on_fairface_final.csv") as output_deepface_csv:
...
f = open (r"C:\Users\tuanm\Desktop\MasterThesis\Output\AGR_ft\on_fairface\fairness_agrnewft3_on_fairface_final.csv", "w", newline ="")
writer = csv.writer(f)
