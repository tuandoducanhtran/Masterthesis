...
os.chdir(r'C:\Users\tuanm\Desktop')
#paths = glob.glob(r'C:\Users\tuanm\OneDrive\Desktop\MasterThesis\Age-Gender-Race-recognition-master\Dataset\UTKFace\*')
paths = glob.glob(r'MasterThesis\Age-Gender-Race-recognition-master\Dataset\UTKFace\*')
# print(paths)
...
scipy.io.savemat(r'C:\Users\tuanm\OneDrive\Desktop\MasterThesis\Age-Gender-Race-recognition-master\data_base.mat', output )
