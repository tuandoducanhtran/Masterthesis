# -*- coding: utf-8 -*-
"""
Created on Wed Sep 21 01:48:13 2022
...
data = scipy.io.loadmat(r"C:\Users\tuanm\Desktop\MasterThesis\Models\AGR_ft\finetune_fairface\data_base_fairface_utk.mat")
images = data['image']
ages = data['age']
genders = data['gender']
races = data['race']
...
model = my_model.My_Model(weights_path = r"C:\Users\tuanm\Desktop\MasterThesis\Models\AGR_ft\utk_newage.h5")
model.fit(x_tr , [y_tr_g , y_tr_a , y_tr_r] , epochs = 20
          , batch_size = 64 , validation_data = (x_cv , [y_cv_g , y_cv_a, y_cv_r]) )
#model.save_weights('recognition_age_3_test.h5', save_format='h5')
model.save_weights(r'C:\Users\tuanm\Desktop\MasterThesis\Models\AGR_ft\finetune_fairface\utk_newage_finetuned.h5', save_format='h5')
##########################################################
