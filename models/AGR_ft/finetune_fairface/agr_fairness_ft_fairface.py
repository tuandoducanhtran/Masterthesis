...
with open (r"C:\Users\tuanm\Desktop\MasterThesis\Output\AGR_ft\finetune_fairface\output_agr_ft_fairface.csv") as output_agr_csv:
...
f = open (r"C:\Users\tuanm\Desktop\MasterThesis\Output\AGR_ft\finetune_fairface\agr_ft_fairface_fairness.csv", "w", newline ="")
writer = csv.writer(f)
