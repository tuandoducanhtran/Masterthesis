...
os.chdir(r'C:\Users\tuanm\Desktop\MasterThesis\Models\AGR')
...
for imgs in image_files:
    try:
        ...
        gender = np.argmax(g)
        race = np.argmax(r)
        agr = picturename, age + 1 , gender_inv_dict[gender]  , race_inv_dict[race]
        values = list(agr)
        print(values)
...
# f = open (r"C:\Users\tuanm\Desktop\MasterThesis\Output\AGR\output_agr.csv", "w", newline ="")
# writer = csv.writer(f)
