...
model = my_model.My_Model(weights_path = r"C:\Users\tuanm\Desktop\MasterThesis\Models\Extended\AGR_conv2\fairface_conv2.h5")
...
f = open (r"C:\Users\tuanm\Desktop\MasterThesis\Output\Extended\AGR_conv2_fairface\on_fairface\output_conv2_fairface_on_fairface.csv", "w", newline ="")
writer = csv.writer(f)
