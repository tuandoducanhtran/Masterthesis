...
image_files = [f for f in glob.glob(r"C:\Users\tuanm\Desktop\MasterThesis\Dataset\Evaluation\UTKFace\*", recursive = True) if not os.path.isdir(f)]
for filename in image_files:
    data.append(os.path.basename(filename))

model = my_model.My_Model(weights_path = r"C:\Users\tuanm\Desktop\MasterThesis\Models\Extended\AGR_conv1\fairface_conv1.h5")
...
f = open (r"C:\Users\tuanm\Desktop\MasterThesis\Output\Extended\AGR_conv1_fairface\on_utk\output_conv1_fairface_on_utk.csv", "w", newline ="")
writer = csv.writer(f)
