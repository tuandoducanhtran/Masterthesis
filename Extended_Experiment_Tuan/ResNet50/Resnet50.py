...
model = my_model.My_Model(weights_path = r"C:\Users\tuanm\Desktop\MasterThesis\Models\Extended\ResNet50\fairface_ResNet50.h5")
...
f = open (r"C:\Users\tuanm\Desktop\MasterThesis\Output\Extended\Resnet_Fairface\on_fairface\output_resnet_fairface_on_fairface.csv", "w", newline ="")
writer = csv.writer(f)
