...
data = scipy.io.loadmat(r'C:\Users\tuanm\Desktop\MasterThesis\Models\Extended\ResNet50\data_base_fairface_utk.mat')
images = data['image']
ages = data['age']
genders = data['gender']
races = data['race']
...
model.save_weights(r'C:\Users\tuanm\Desktop\MasterThesis\Models\Extended\ResNet50\fairface_ResNet50.h5', save_format='h5')
##########################################################
