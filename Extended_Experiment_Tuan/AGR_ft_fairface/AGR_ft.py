...
model = my_model.My_Model(weights_path = r"C:\Users\tuanm\Desktop\MasterThesis\Models\Extended\AGR_conv3\fairface_conv3.h5")
...
f = open (r"C:\Users\tuanm\Desktop\MasterThesis\Output\Extended\AGR_conv3_fairface\on_fairface\output_conv3_fairface_on_fairface.csv", "w", newline ="")
writer = csv.writer(f)
