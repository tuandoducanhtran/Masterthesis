...
data = scipy.io.loadmat(r'C:\Users\tuanm\Desktop\MasterThesis\Models\Extended\AGR_conv3\data_base_utknew.mat')
images = data['image']
ages = data['age']
genders = data['gender']
races = data['race']
...
model.save_weights(r'C:\Users\tuanm\Desktop\MasterThesis\Models\Extended\AGR_conv3\utk_newage_conv3.h5', save_format='h5')
##########################################################
